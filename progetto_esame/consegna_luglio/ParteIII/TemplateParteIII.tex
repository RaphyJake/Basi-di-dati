...
\begin{center}
	\begin{footnotesize}
		\begin{tabular}{|c|p{2.7cm}|p{2.7cm}|p{2.7cm}|p{2.7cm}|}
			...
			\hline
			artisti & SELECT, INSERT, UPDATE, DELETE & SELECT & SELECT & SELECT \\
			\hline
			brani & SELECT, INSERT, UPDATE, DELETE & SELECT & SELECT & SELECT \\
			\hline
			contributi\_brani & SELECT, INSERT, UPDATE, DELETE & - & - & - \\
			\hline
			esibizioni & SELECT, INSERT, UPDATE, DELETE & SELECT & SELECT & SELECT \\
			\hline
			serate & SELECT, INSERT, UPDATE, DELETE & SELECT & SELECT & SELECT \\
			\hline
			voti & SELECT, INSERT, UPDATE, DELETE & - & - & - \\
			\hline
