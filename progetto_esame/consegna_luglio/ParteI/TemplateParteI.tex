...
%[schema logico relazionale nella notazione vista a lezione]
	\begin{itemize}
		...
		% c'è qualcosa che non mi torna su questa associazione, da capire come gestire perchè dovrebbe esserci un codice artista per ogni riga...forse ci vuole una chiave aggiuntiva oppure tre relazioni, titolo/artista...più facile
